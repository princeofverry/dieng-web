    ...
    return (
        <>
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
                ...
                <p className='md:text-2xl text-md text-white font-semibold' data-aos="zoom-in" data-aos-duration="1000">Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque, unde!</p>
            </div>
